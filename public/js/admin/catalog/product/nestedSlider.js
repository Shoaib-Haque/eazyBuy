...
*/
function nestedRemoveImage(slideDivId, rowid, iIndex, jIndex, rowIndex) {
  jQuery.noConflict()(function ($) { 
    $(document).ready(function () {
      ...
      fileStatus.setAttribute("name", "nestedFileStatus"+iIndex+jIndex+rowIndex+k);
      //console.log(fileStatus.name);
...
function nestedUploadImage(event, rowid, iIndex, jIndex, rowIndex) {
  jQuery.noConflict()(function ($) { 
    $(document).ready(function () {
      ...
      for (var f = 0; f < files.length; f++) { 
        ...
        */
        ...
        slideImg.id = "slideimg"+nestedSlideDivCount+rowid;
        slideImg.name = "slideimg"+nestedSlideDivCount+rowid;
        ...
        */
        ...
        removeImg.id = "removeImg"+nestedSlideDivCount+rowid;
        removeImg.addEventListener('click', function(e) {
          nestedRemoveImage($(this).parent().attr('id'), rowid, iIndex, jIndex, rowIndex);
        });

        var k = parseInt(document.getElementById("nestedSlideCount"+rowid).value);
        ...
        document.getElementById("nestedSlideCount"+rowid).value = k+1;
